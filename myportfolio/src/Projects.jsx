...
import "./Projects.css";
import todonix from './img/p1.png'; 

const projects = [
  {
    title: "Todonix-A Task Manager",
    description: "A Simple Task Manager built with React and Framer Motion.",
    tech: ["React", "Framer Motion", "Tailwind"],
    image: todonix,
    live: "https://todonix.netlify.app",
    github: "https://github.com/nithish2211/todoApp",
  },
  {
