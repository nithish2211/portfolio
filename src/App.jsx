  ...
  return (
    <div className="portfolio">
      ...
      <footer className="bottom-nav">
        <a href="#about" className="nav-item"><p>About</p></a>
        <a href="#skills" className="nav-item"><p>Skills</p></a>
        <a href="#projects" className="nav-item"><p>Projects</p></a>
        <a href="#contact" className="nav-item"><p>Contact</p></a>
      </footer>
    </div>
  );
}
